...
echo "Running DualCOS on CIFAR100"
...
experiment_type="dualcos"    # Whether to run dualcos or dfme experiment
ensemble_size=2              # Value must be 2 or higher for DualCOS. May be any value for DFME
